...
def slurp_vol_r025_s5_p20_g000_long_manager(y, s=5, k=1, e=1,j=1,q=1.0):
    return slurp_vol_manager_factory(y=y, s=s, r=0.025,  e=e, phi=0.20, gamma=0, delta=0,j=j,q=q)


def slurp_vol_r001_s5_p20_g000_long_manger(y, s=5, k=1, e=1,j=1,q=1.0):
    return slurp_vol_manager_factory(y=y, s=s, r=0.01, e=e, phi=0.20, gamma=0, delta=0,j=j,q=q)


def slurp_vol_r025_s25_p20_g000_long_manager(y, s=25, k=1, e=1,j=1,q=1.0):
    return slurp_vol_manager_factory(y=y, s=s, r=0.025,  e=e, phi=0.20, gamma=0, delta=0,j=j,q=q)


def slurp_vol_r001_s25_p20_g000_long_manger(y, s=25, k=1, e=1,j=1,q=1.0):
    return slurp_vol_manager_factory(y=y, s=s, r=0.01,  e=e, phi=0.20, gamma=0, delta=0,j=j,q=q)
...
SLURP_GAMMA000_LONG_MANAGERS = [slurp_vol_r025_s5_p20_g000_long_manager,
...
def slurp_vol_r025_s5_p20_g100_long_manager(y, s=5, k=1, e=1,j=1,q=1.0):
...
SLURP_GAMMA100_LONG_MANAGERS = [slurp_vol_r025_s5_p20_g100_long_manager,
