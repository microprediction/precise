...
def ppo_sk_lw_pcov_d0_n100_sharpe_long_manager(y, s, k=1, e=1,j=1):
    return ppo_long_manager_factory(y=y,s=s,f=buf_sk_lw_pcov_d0_n100, method='max_sharpe',j=j)


def ppo_sk_glcv_pcov_d0_n100_sharpe_long_manager(y, s, k=1, e=1,j=1):
    return ppo_long_manager_factory(y=y,s=s,f=buf_sk_glcv_pcov_d0_n100, method='max_sharpe',j=j)


def ppo_sk_glcv_pcov_d0_n100_t0_sharpe_long_manager(y, s, k=1, e=1,j=1):
    return ppo_long_manager_factory(y=y,s=s,f=buf_sk_glcv_pcov_d0_n100_t0, method='max_sharpe',j=j)


def ppo_sk_mcd_pcov_d0_n100_sharpe_long_manager(y, s, k=1, e=1,j=1):
    return ppo_long_manager_factory(y=y,s=s,f=buf_sk_mcd_pcov_d0_n100, method='max_sharpe',j=j)
