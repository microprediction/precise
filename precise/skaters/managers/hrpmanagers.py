...
def hrp_weak_vol_ewa_r001_n200_s50_g050_l21_long_manager(y, s, k=1, e=1, j=1, q=1.0):
    assert k == 1
    return schur_weak_vol_ewa_manager_factory(y=y, s=s, r=0.001, n_emp=200, n_split=50, e=e, gamma=0.5, delta=0, j=j,
                                              q=q, l=21)


def hrp_vol_weak_ewa_r001_n200_s50_l21_long_manager(y, s, k=1, e=1, j=1, q=1.0):
    assert k == 1
    return schur_vol_weak_ewa_manager_factory(y=y, s=s, e=e, r=0.01, n_split=50, n_emp=200, gamma=0.0, delta=0, zeta=0,
                                              j=j, q=q, l=21)


def hrp_vol_weak_ewa_r001_n200_s50_g050_l21_long_manager(y, s, k=1, e=1, j=1, q=1.0):
    assert k == 1
    return schur_vol_weak_ewa_manager_factory(y=y, s=s, e=e, r=0.01, n_split=50, n_emp=200, gamma=0.5, delta=0, zeta=0,
                                              j=j, q=q, l=21)
...
HRP_21_LONG_MANGERS = [hrp_weak_vol_ewa_r001_n200_s50_l21_long_manager,
