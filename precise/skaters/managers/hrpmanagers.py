from precise.skaters.managers.schurmanagerfactory import schur_weak_weak_pm_manager_factory, \
    schur_weak_weak_ewa_manager_factory, schur_vol_vol_ewa_manager_factory,\
...
def hrp_vol_weak_ewa_r001_n200_s50_l21_long_manager(y, s, k=1, e=1,j=1,q=1.0):
    assert k==1
    return schur_vol_weak_ewa_manager_factory(y, s, e, r=0.01, n_split=50, gamma=0.0, delta=0, zeta=0,j=j,q=q,l=21)


def hrp_vol_weak_ewa_r001_n200_s50_g050_l21_long_manager(y, s, k=1, e=1,j=1,q=1.0):
    assert k==1
    return schur_vol_weak_ewa_manager_factory(y, s, e, r=0.01, n_split=50, gamma=0.5, delta=0, zeta=0,j=j,q=q,l=21)
