from precise.skaters.managers.schurmanagerfactory import schur_diag_diag_ewa_manager_factory, \
    schur_diag_diag_pm_manager_factory, schur_diag_equal_ewa_manager_factory, schur_vol_vol_ewa_manager_factory, schur_diag_diag_ewa_manager_factory

# Some Hierarchical Risk-Parity managers from the literature
# (Schur managers with gamma=delta=0 can also be considered in this category)
...
def lopez_de_prado_s5_n50_long_manager(y, s, k=1, e=1):
    return schur_diag_diag_ewa_manager_factory(y=y, s=s, n_buffer=50, e=e, gamma=0, delta=0)
...
def lopez_de_prado_s5_n100_long_manager(y, s, k=1, e=1):
    return schur_diag_diag_ewa_manager_factory(y=y, s=s, n_buffer=100, e=e, gamma=0, delta=0)
