...
# hrp_portfolio_factory(seriator=None, alloc=None, port=None, splitter=None, cov=None, pre=None, n_split=5, gamma=0.0)
...
def hrp_weak_pm_manager_factory(y, s, target, n_emp, r, a=1.0, b=None, n_split=5, gamma=0.0, a_alloc=1.0, b_alloc=None):
    ...
    hrp_port = partial(hrp_portfolio_factory, alloc=alloc, port=leaf_port, n_split=n_split, gamma=gamma)
