...
def buf_sk_lw_pcov_d0_n100(y: X_TYPE = None, s: dict = None, k=1, e=1):
    """ Ledoit-Wolf covariancecomparisonutil based estimator for IID observations """
    assert k == 1
...
def buf_sk_gl_pcov_d0_n100(y: X_TYPE = None, s: dict = None, k=1, e=1):
    """ Graphical Lasso covariancecomparisonutil based estimator for IID observations """
    assert k == 1
...
def buf_sk_glcv_pcov_lars_d0_n100(y: X_TYPE = None, s: dict = None, k=1, e=1):
    """ Graphical Lasso CV LARS model covariancecomparisonutil based estimator for IID observations """
    assert k == 1
...
def buf_sk_mcd_pcov_d0_n100(y: X_TYPE = None, s: dict = None, n_buffer: int = 100, k=1, e=1):
    """ Minimumn covariancecomparisonutil based estimator for IID observations """
    assert k == 1
...
def buf_sk_lw_pcov_d1_n100(y: X_TYPE = None, s: dict = None, k=1, e=1):
    """ Ledoit-Wolf covariancecomparisonutil based estimator for IID changes """
    assert k == 1
...
def buf_sk_mcd_pcov_d1_n100(y: X_TYPE = None, s: dict = None,  k=1, e=1):
    """ Minimumn covariancecomparisonutil based estimator for IID changes """
    assert k == 1
    # https://scikit-learn.org/stable/modules/generated/sklearn.covariance.MinCovDet.html#sklearn.covariance.MinCovDet
