...
def ewa_pm_emp_scov_r01_n300(s, y, k=1, e=1):
    return ewa_pm_factory(s=s, y=y, k=k, r=0.01, n_emp=300)


def ewa_pm_emp_scov_r01_n300_t0(s, y, k=1, e=1):
    return ewa_pm_factory(s=s, y=y, k=k, r=0.01, n_emp=300, target=0)
...
def ewa_pm_emp_scov_r01_n200_t0(s, y, k=1, e=1):
    return ewa_pm_factory(s=s, y=y, k=k, r=0.01, n_emp=200, target=0)
...
EWA_PM_EMP_D0_COV_SKATERS_TM = [ewa_pm_emp_scov_r01_n100, ewa_pm_emp_scov_r01_n200, ewa_pm_emp_scov_r01_n300,
...
EWA_PM_EMP_D0_COV_SKATERS_T0 = [ewa_pm_emp_scov_r01_n100_t0, ewa_pm_emp_scov_r01_n200_t0, ewa_pm_emp_scov_r01_n300_t0,
