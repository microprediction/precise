...
def ewa_emp_pcov_d0_r01(y, s, k=1):
    return ema_pcov_r(y=y,s=s,k=k,r=0.01)


def ewa_emp_pcov_d0_r02(y, s, k=1):
    return ema_pcov_r(y=y,s=s,k=k,r=0.02)


def ewa_emp_pcov_d0_r05(y, s, k=1):
    return ema_pcov_r(y=y,s=s,k=k,r=0.05)


def ewa_emp_pcov_d0_r10(y, s, k=1):
...
def ewa_emp_pcov_d1_r01(y:Y_DATA_TYPE, s:dict, k=1):
    """
...
def ewa_emp_pcov_d1_r02(y:Y_DATA_TYPE, s:dict, k=1):
...
def ewa_emp_pcov_d1_r10(y:Y_DATA_TYPE, s:dict, k=1):
