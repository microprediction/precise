...
import numpy as np
from precise.precision.known import known_rcov_init, known_rcov_update
...
def test_known():
    ...
    rho = 0.01
    kcov = known_rcov_init(adjacency=adjacency,rho=rho)
    for observation in data:
        kcov = known_rcov_update(m=kcov, x=observation)
