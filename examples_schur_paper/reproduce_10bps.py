...
N_OBSERVED = 1200  # Number of observations seen when estimating Sigma
rnd_cov_kwargs = {'rho':RHO,'severity':SEVERITY,'n_dim':N_DIM}
MAX_TIME = 6*60    # Seconds to spend on each of three experiments

if __name__=='__main__':
    xlabel = 'p= ' + str(N_DIM) + r' $\rho=' + str(RHO) + 'a=' + str(N_ANCHOR) + 'o=' + str(N_OBSERVED)
