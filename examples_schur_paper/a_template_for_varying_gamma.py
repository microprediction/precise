...
# Make a "seed" symmetric cov matrix somehow
rho = 0.35
N_DIM = 500
...
# These params will determine how the true matrix is generated from the seed matrix
N_ANCHOR = 150   # e.g. 50, 100 We create the "anchor" cov matrix using simulation of anchor_cov
