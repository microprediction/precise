...
A collection of autonomous incremental estimators for covariance, precision, correlation, portfolios and ensembles.   
...
![](https://github.com/microprediction/precise/blob/main/images/incremental.png =400x600)
